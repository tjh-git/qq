...
public class ChatGroup {// 单聊界面
	...
	class Event extends MouseAdapter {
		public void mouseClicked(MouseEvent e) {
			...
			} else if (e.getComponent().equals(file)) {// 群文件共享
			...
			} else if (e.getComponent().equals(add)) {// 添加群成员
	...
	public static void main(String[] args) {
		new ChatGroup(1000, "小新", 1000, "李国迎", null, null, null, (byte) 1, null);
	}
}
